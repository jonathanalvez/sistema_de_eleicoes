...
# election stuff
SITE_TITLE = get_from_env('SITE_TITLE', 'Eleições SatedSC')
MAIN_LOGO_URL = get_from_env('MAIN_LOGO_URL', 'https://satedsc.org/wp-content/uploads/sites/15/2020/12/cropped-novo-logo-branca.png')
...
WELCOME_MESSAGE = get_from_env('WELCOME_MESSAGE', "Bem-vindo ao sistema de eleições da SatedSC")
